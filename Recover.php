...
<html lang="en">
	<head>
	  ...
	  <title>i-Mobiliária - Recuperar Senha</title>
			...
			<center>
                ...
                <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <button type="submit" class="btn btn-b">Recuperar</button>
                    </div>
                  </div>
                </form>
				<div class="text-center section-t3">
					<p class="text-center login-wrapper-footer-text">Ainda não tem conta? <a href="Cadastro.html" class="text-reset">Crei aqui :)</a></p>
					<p class="text-center login-wrapper-footer-text"><a href="Index.html" class="text-reset">Voltar para a Home</a></p>
				</div>
			</center>
				</div>
